...
lab5 <- read.csv("/Users/nehirarpat/Documents/GitHub/Lab5/lab5data.csv")
```
...
```
    ...
    ## Univariate Tests of "Gender":
    ## ───────────────────────────────────────────────────────────────
    ##                Sum of Squares   df Mean Square      F     p    
    ## ───────────────────────────────────────────────────────────────
    ##  No: "Gender"         139.193    1     139.193  2.022  .160    
    ## Yes: "Gender"        1236.144    1    1236.144 17.958 <.001 ***
    ## Residuals                     3924                             
    ## ───────────────────────────────────────────────────────────────
...
```
    ...
    ## Univariate Tests of "Greek":
    ## ───────────────────────────────────────────────────────────────
    ##                 Sum of Squares   df Mean Square     F     p    
    ## ───────────────────────────────────────────────────────────────
    ##   Men: "Greek"         624.594    1     624.594 9.074  .004 ** 
    ## Women: "Greek"         159.141    1     159.141 2.312  .134    
    ## Residuals                      3924                            
    ## ───────────────────────────────────────────────────────────────
    ## Note. Identical to the results obtained with SPSS GLM EMMEANS syntax.
    ## 
...
The hypothesis is not supported because the p-value is greater than .05.
The difference of GPA between Greek women and non-Greek women is
statistically insignificant meaning Greekness in women has no effect on
GPA.
...
The hypothesis is not supported. There is no statistically significant
difference in GPA between men and women regardless of Greekness (no main
effect of Gender). This indicates that gender has no effect on GPA
whether the person is Greek or not.
