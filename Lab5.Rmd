...
```
The hypothesis is not supported because the p-value is greater than .05. The difference of GPA between Greek women and non-Greek women is statistically insignificant meaning Greekness in women has no effect on GPA.
...
```
The hypothesis is not supported. There is no statistically significant difference in GPA between men and women regardless of Greekness (no main effect of Gender). This indicates that gender has no effect on GPA whether the person is Greek or not.
